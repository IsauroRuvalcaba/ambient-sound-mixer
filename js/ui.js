export class UI {
  ...
  renderSoundCards(sounds) {
    // this.soundCardsContainer.replaceChildren() I think it's the same as Traversy Media example below
  ...
  updateSoundPlayButton(soundId, isPlay) {
  ...
  removeCustomPreset(presetId) {
    ...
    if (button) {
      // the remove() is a method on querySelector that removes elements
      button.remove();
    }
  }
